...
tuple<uint, uint, bool, Particl (*)(uint, uint)> click;
...
void makePixel(uint x, uint y, Color3 color) {
...
void onMouse(int button, int state, int x, int y) {
    ...
    click  = tuple<uint, uint, Particle (*)(uint, uint)> (x1, y1, state == GLUT_DOWN, p);
